...
function Nav({ onClickBag, itemsInCart }) {
    ...
    useEffect(() => {
        const circle = document.querySelector("#cart-circle");
        if (itemsInCart < 1) {
        ...
        <ul>
            ...
            <li>
                <div className="nav-bag-wrapper">
                    <a href="#" onClick={onClickBag} className="bag-icon">
                    ...
                    <svg id="cart-circle" width="16" height="16">
